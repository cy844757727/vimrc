...
let g:colors_NormalMode = ''
let g:colors_InsertMode = ''
...
if !get(g:, 'solarized_use16', &t_Co < 256)
  if &background ==# 'dark'
    ...
    hi CursorLine ctermfg=NONE ctermbg=235 guifg=NONE guibg=#09353f guisp=#586e75 cterm=NONE gui=NONE
    ...
    hi VertSplit ctermfg=242 ctermbg=236 guifg=#002B36 guibg=#002B36 guisp=NONE cterm=NONE gui=NONE
...
hi CursorLine ctermfg=NONE ctermbg=15 guifg=NONE guibg=#09353F guisp=#93a1a1 cterm=NONE,underline gui=NONE,underline
if get(g:, "solarized_diffmode", "") == "high"
  hi DiffAdd ctermfg=2 ctermbg=NONE guifg=#859900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffChange ctermfg=3 ctermbg=NONE guifg=#b58900 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffDelete ctermfg=1 ctermbg=NONE guifg=#dc322f guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
if &background == 'light'
hi VertSplit guifg=#FDF6E3 guibg=#FDF6E3
hi EndOfBuffer guifg=#FDF6E3
hi CursorLine guibg=#EEE8D5 cterm=NONE gui=NONE
endif