...
hi TabLineSeparator guibg=#A2A2A2 guifg=#1E1E1E
...
hi VertSplit ctermfg=253 ctermbg=253 guifg=#A2A2A2 guibg=#A2A2A2 "#C5C5C5
hi StatusLine ctermfg=16 ctermbg=253 cterm=NONE guifg=#FFFFFF guibg=#007ACC
hi StatusLineNC ctermfg=16 ctermbg=252 cterm=NONE guifg=#000000 guibg=#A2A2A2 "#C5C5C5 gui=NONE
